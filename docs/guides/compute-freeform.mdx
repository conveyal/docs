...
```
where n is the desired threshold number of opportunities.
...
* Dn: the number of minutes required to reach a threshold of n opportunities. A value of -1 indicates the specified threshold is not reached within the maximum cutoff specified when the regional analysis was created.
...
origin|destinations|percentile|D2|0|1|2|3|...|118|119
------|------------|----------|--|-|-|-|-|---|---|---
