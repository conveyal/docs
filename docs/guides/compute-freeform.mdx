...
* `dual`: the number of minutes required to reach a threshold of n opportunities. A value of 0 indicates the specified threshold is not reached within the maximum cutoff specified when the regional analysis was created.
