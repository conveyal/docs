...
## Spatial dataset
A spatial dataset has one or more layers representing origin points or numeric counts of destination opportunities at particular locations in your [region](#region). See [uploading opportunities](/prepare-inputs/upload-spatial-data#uploading-a-spatial-dataset).
