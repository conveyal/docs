...
Conveyal's methods are not designed for polygons averaging less than one opportunity per grid cell. Processing low density layers at high zoom levels may yield unexpected results; contact your support team for more information.
:::
