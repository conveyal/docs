...
* When using freeform spatial datasets as destinations in a regional analysis, you can specify only a single layer for now. Grid and freeform destinations cannot yet be mixed.
