...
Once changed, modifications will show available options to <Button variantColor='green'><FaSave /> Save changes</Button> and <Button variantColor='blue'><FaUndo /></Button> Undo all changes. Once changes have been saved or undone, you can navigate back to the list of modifications by clicking on the <FaChevronLeft /> button at the top left of the modification panel.
