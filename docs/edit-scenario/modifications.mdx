...
Similar to the Add Streets modification, properties are set at the level of the modification, and multiple areas can be specified. Thus, separate modifications are needed to specify different types of areas.
