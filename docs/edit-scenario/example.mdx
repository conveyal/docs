...
1. Click <Button variantColor='green'><FaSave /> Save changes</Button> then return to the main list of Modifications with the <FaChevronLeft /> icon at the top of the modification details panel.
