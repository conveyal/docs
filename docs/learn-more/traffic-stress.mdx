---
title: Cycling Level of Traffic Stress
---
...
The initial version of the LTS methodology does not cover signalized intersections, so this round does not consider vertices derived from nodes with signal tags, and those vertices are not affected.
...
Alternatively, you can upload a shapefile with an `lts` attribute as a data source, then reference it in a [custom modification](/edit-scenario/modifications#custom-lts).
