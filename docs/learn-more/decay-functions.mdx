...
*Please note that the exponenital decay option visble in the Conveyal web app refers to the half-life exponential decay function described below. The fixed-decay form described in this section can only be specified manually via JSON.*
