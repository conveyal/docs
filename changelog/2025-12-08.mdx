...
- Handles origins and destinations linked to the same network edge ([#980](https://github.com/conveyal/r5/pull/980)). This change may result in lower accessibility results compared to past versions of R5, especially near long network edges and when using low travel time cutoffs or decay functions.
- Limits use of custom elevation data to walk and bike modes, not car ([#972](https://github.com/conveyal/r5/pull/972))
